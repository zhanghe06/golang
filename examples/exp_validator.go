...
// UserValidate contains user information
...
func main() {
	...
	_ = zh_translations.RegisterDefaultTranslations(validate, transZH)

	translateAll(transEN)
	translateAll(transZH)
	translateIndividual(transZH)
	translateOverride(transZH) // yep you can specify your own in whatever locale you want!
}
